...
struct WidgetService: WidgetServiceProtocol {
    ...
    func updateWidget(entries: [(text: String, fontStyle: String?, gradientColors: [String], backgroundImage: UIImage?, textColor: String?, imageAlignmentX: Double?, imageAlignmentY: Double?)]) {
        ...
        for (index, entry) in entries.enumerated() {
            ...
            let snapshot = WidgetSnapshot(
                ...
                imageAlignmentX: entry.imageAlignmentX,
                imageAlignmentY: entry.imageAlignmentY,
                updatedAt: .now
            )
    ...
    func updateFavoritesWidget(favorites: [(text: String, fontStyle: String?, gradientColors: [String], backgroundImage: UIImage?, textColor: String?, imageAlignmentX: Double?, imageAlignmentY: Double?)]) {
        ...
        for (index, fav) in favorites.prefix(50).enumerated() {
            ...
            entries.append(FavoriteWidgetEntry(text: fav.text, fontStyle: fav.fontStyle, gradientColors: fav.gradientColors, backgroundImageFilename: imageFilename, textColor: fav.textColor, imageAlignmentX: fav.imageAlignmentX, imageAlignmentY: fav.imageAlignmentY))
        }
