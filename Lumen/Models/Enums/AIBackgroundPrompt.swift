...
struct AIBackgroundPrompt: Sendable, Identifiable, Codable {
    ...
    private static let sharedNegative = "text, words, letters, numbers, watermark, signature, face, person, human, animal, photo, realistic, ugly, blurry, noisy, low quality, distorted, deformed"
    ...
    static let library: [AIBackgroundPrompt] = {
        ...
        func add(_ name: String, _ category: PromptCategory, _ prompt: String) {
            prompts.append(AIBackgroundPrompt(
                id: "ai_\(index)",
                prompt: prompt,
